...
-- Final guard for the authenticated project creation flow.
-- This intentionally repeats the bucket/policy setup so production drift or
-- a previously interrupted migration chain can be repaired idempotently.
