...
export function ProjectGrid({
  ...
  if (!projects.length) {
    return (
      <div className="rounded-3xl border border-border/70 bg-background/25 p-4 text-center sm:rounded-4xl sm:p-6">
  ...
  return (
    <div
      className="grid grid-cols-2 gap-2 md:gap-4 xl:grid-cols-3"
